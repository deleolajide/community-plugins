...
/**
 * The Class ChatViewPlugin.
 */
public class ChatViewPlugin implements Plugin, PropertyEventListener {

	/** The Constant INSTANCE. */
	public static ChatViewPlugin INSTANCE;

	private static final String CUSTOM_AUTH_FILTER_PROPERTY_NAME = "chatview.restapi.customAuthFilter";
	...
	/**
	 * Gets the single instance of ChatViewPlugin.
	 *
	 * @return single instance of ChatViewPlugin
	 */
	public static ChatViewPlugin getInstance() {
		return INSTANCE;
	}
	...
	public void initializePlugin(PluginManager manager, File pluginDirectory) {
		...
		secret = JiveGlobals.getProperty("chatview.restapi.secret", "");
		...
		customAuthFilterClassName = JiveGlobals.getProperty("chatview.restapi.customAuthFilter", "");

		// See if the service is enabled or not.
		enabled = JiveGlobals.getBooleanProperty("chatview.restapi.enabled", true);

		// See if the HTTP Basic Auth is enabled or not.
		httpAuth = JiveGlobals.getProperty("chatview.restapi.httpAuth", "basic");

		// Get the list of IP addresses that can use this service. An empty list
		// means that this filter is disabled.
		allowedIPs = StringUtils.stringToCollection(JiveGlobals.getProperty("chatview.restapi.allowedIPs", ""));
	...
	public void setSecret(String secret) {
		JiveGlobals.setProperty("chatview.restapi.secret", secret);
		this.secret = secret;
	}
	...
	public void setAllowedIPs(Collection<String> allowedIPs) {
		JiveGlobals.setProperty("chatview.restapi.allowedIPs", StringUtils.collectionToString(allowedIPs));
	...
	public void setEnabled(boolean enabled) {
		...
		JiveGlobals.setProperty("chatview.restapi.enabled", enabled ? "true" : "false");
	}
	...
	public void setHttpAuth(String httpAuth) {
		...
		JiveGlobals.setProperty("chatview.restapi.httpAuth", httpAuth);
	}
	...
	public void propertySet(String property, Map params) {
		if (property.equals("chatview.restapi.secret")) {
			this.secret = (String) params.get("value");
		} else if (property.equals("chatview.restapi.enabled")) {
			this.enabled = Boolean.parseBoolean((String) params.get("value"));
		} else if (property.equals("chatview.restapi.allowedIPs")) {
			this.allowedIPs = StringUtils.stringToCollection((String) params.get("value"));
		} else if (property.equals("chatview.restapi.httpAuth")) {
