<%@ page
	import="java.util.*,
                ...
                org.jivesoftware.util.*,org.jivesoftware.openfire.plugin.rest.ChatViewPlugin,
...
<%
	...
	ChatViewPlugin plugin = (ChatViewPlugin) XMPPServer.getInstance().getPluginManager()
			.getPlugin("chatview");
